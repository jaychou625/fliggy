...
public class SendMailUtil {
    ...
    //发件人邮箱
    private static String myEmailAccount = "56650666@qq.com";

    //发件人邮箱密码（授权码）
    //在开启SMTP服务时会获取到一个授权码，把授权码填在这里
    private static String myEmailPassword = "vyriiqzgigvnbggc";
  ...
      */
       public static void sendEmail(String toEmailAddress, String emailTitle, String emailContent) throws Exception{
            ...
            // 发送服务器需要身份验证
             ...
             msg.setFrom(new InternetAddress(myEmailAccount,"fliggyUpdate", "UTF-8"));
